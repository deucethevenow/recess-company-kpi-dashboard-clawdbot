-- =============================================================================
-- CREATE VIEW: Pipeline Coverage by Owner
-- =============================================================================
-- Run this in BigQuery Console to create the view
-- Dataset: App_KPI_Dashboard
-- =============================================================================

CREATE OR REPLACE VIEW `stitchdata-384118.App_KPI_Dashboard.pipeline_coverage_by_owner` AS
...
owner_pipeline_by_quarter AS (
    ...
    FROM deal_to_owner WHERE rn = 1 GROUP BY owner_name, close_quarter
),
deals_2025 AS (
...
quarters AS (SELECT quarter FROM UNNEST(['Q1', 'Q2', 'Q3', 'Q4']) as quarter)
